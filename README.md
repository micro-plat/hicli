...
- [约束配置](#约束配置)
        ...
        - [三、字典表约束配置](#三字典表约束配置)
        - [查询按钮el_q_btn](#查询按钮el_q_btn)
        - [列表按钮el_l_btn](#列表按钮el_l_btn)
        - [详情页面按钮el_d_btn](#详情页面按钮el_d_btn)
- [项目管理](#项目管理)
      - [一、克隆](#一克隆)
      - [二、拉取](#二拉取)
      - [三、撤销修改](#三撤销修改)
...
| --------- | ------------------------------------- | :---: | :--------------------: | :------- |
| name      | 按钮名称                              |  否   |           -            | -        |
| handler   | 请求后端handler名称，按钮为btn时必须                   |  是   |           -            | -        |
| method    | 前端方法名称                          |  是   |           -            | 自动生成 |
| mode      | 按钮模式                              |  是   | btn/query/batch/dialog | btn      |
| condition | 按钮展示条件                          |  是   |           -            | -        |
| confirm   | 点击按钮确认提示                      |  是   |           -            | -        |
| path      | 弹框文件路径,按钮类型为dialog有效 |  是   |           -            | -        |
...
| handler   | 请求后端handler名称，按钮为btn时必须 |  是   |     -      | -        |
| method    | 前端方法名称                         |  是   |     -      | 自动生成 |
| mode      | 按钮模式                             |  是   | btn/dialog | btn      |
| condition | 按钮展示条件                         |  是   |     -      | -        |
| confirm   | 点击按钮确认提示                     |  是   |     -      | -        |
| path      | 弹框文件路径,按钮类型为dialog时必须  |  是   |     -      | -        |
